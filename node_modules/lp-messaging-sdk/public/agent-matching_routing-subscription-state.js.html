...
<head>
  ...
  <title> agent-matching/routing-subscription-state.js</title>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header class="page-title">
                    <p>Source</p>
                    <h1>agent-matching/routing-subscription-state.js</h1>
                </header>
 ...
 * @typedef {string} RoutingSubscriptionState
 */

/**
 * The different states of a routing task subscription.
 * @enum {RoutingSubscriptionState}
 * @category Routing
 */
const RoutingSubscriptionState = {
...
module.exports = RoutingSubscriptionState;
</code></pre>
        </article>
    </section>
