...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>CSDSCache<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>CSDS cache</p></div>
...
<article>
    ...
    <h4 class="name" id="CSDSCache">
        <a class="href-link" href="#CSDSCache">#</a>
        
        <span class="code-name">
            
                new CSDSCache<span class="signature">()</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="services_csds-cache.js.html" class="button">View Source</a>
            <span>
                <a href="services_csds-cache.js.html">services/csds-cache.js</a>, <a href="services_csds-cache.js.html#line7">line 7</a>
            </span>
        </p>
    ...
    <h4 class="name" id="lookup">
        <a class="href-link" href="#lookup">#</a>
        ...
        <span class="code-name">
                ...
                lookup<span class="signature">(accountId, serviceName)</span><span class="type-signature"> &rarr; {Promise.&lt;string>}</span>
    ...
    <div class="description">
        <p>Returns the hostname for a given service for a specific account.</p>
    </div>
...
<span class="param-type">string</span>
  ...
  <td class="description last"><p>A token representing a Liveperson service, for a complete list see CSDS.ServiceName</p></td>
</tr>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="services_csds-cache.js.html" class="button">View Source</a>
            <span>
                <a href="services_csds-cache.js.html">services/csds-cache.js</a>, <a href="services_csds-cache.js.html#line30">line 30</a>
            </span>
        </p>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>the hostname of the specified service for this account</p></div>
