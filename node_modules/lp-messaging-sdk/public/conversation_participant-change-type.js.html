...
<head>
  ...
  <title> conversation/participant-change-type.js</title>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header class="page-title">
                    <p>Source</p>
                    <h1>conversation/participant-change-type.js</h1>
                </header>
 ...
 * @typedef {string} ParticipantChangeType
 */
...
const ParticipantChangeType = {
    ADD: 'ADD',
    REMOVE: 'REMOVE',
    SUGGEST: 'SUGGEST'
};

module.exports = ParticipantChangeType;
</code></pre>
        </article>
    </section>
