...
<head>
  ...
  <title> BrandWebsocketConnection</title>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header class="page-title">
                    <p>Class</p>
                    <h1>BrandWebsocketConnection</h1>
                </header>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>BrandWebsocketConnection<span class="signature">()</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>Represents a brand side websocket connection to UMS.</p></div>
...
<article>
    ...
    <h4 class="name" id="BrandWebsocketConnection">
        <a class="href-link" href="#BrandWebsocketConnection">#</a>
        
        <span class="code-name">
            
                new BrandWebsocketConnection<span class="signature">()</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="connection_connection-websocket-brand.js.html" class="button">View Source</a>
            <span>
                <a href="connection_connection-websocket-brand.js.html">connection/connection-websocket-brand.js</a>, <a href="connection_connection-websocket-brand.js.html#line19">line 19</a>
            </span>
        </p>
    ...
    <h4 class="name" id="_getWebsocketUrl">
        <a class="href-link" href="#_getWebsocketUrl">#</a>
        ...
        <span class="code-name">
                ...
                _getWebsocketUrl<span class="signature">()</span><span class="type-signature"></span>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="connection_connection-websocket-brand.js.html" class="button">View Source</a>
            <span>
                <a href="connection_connection-websocket-brand.js.html">connection/connection-websocket-brand.js</a>, <a href="connection_connection-websocket-brand.js.html#line264">line 264</a>
            </span>
        </p>
    ...
    <h4 class="name" id="_onAuthInvalidError">
        <a class="href-link" href="#_onAuthInvalidError">#</a>
        ...
        <span class="code-name">
                ...
                _onAuthInvalidError<span class="signature">()</span><span class="type-signature"></span>
    ...
    <div class="description">
        <p>Forces a reauth in TokenMaintainer when ._connect() is called again</p>
    </div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="connection_connection-websocket-brand.js.html" class="button">View Source</a>
            <span>
                <a href="connection_connection-websocket-brand.js.html">connection/connection-websocket-brand.js</a>, <a href="connection_connection-websocket-brand.js.html#line113">line 113</a>
            </span>
        </p>
    ...
    <h4 class="name" id="_subscribeRoutingTasks">
        <a class="href-link" href="#_subscribeRoutingTasks">#</a>
        ...
        <span class="code-name">
                ...
                _subscribeRoutingTasks<span class="signature">(accountId, agentId)</span><span class="type-signature"></span>
    ...
    <div class="description">
        <p>Makes the websocket call to Agent Matching to subscribe for rings.</p>
    </div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="connection_connection-websocket-brand.js.html" class="button">View Source</a>
            <span>
                <a href="connection_connection-websocket-brand.js.html">connection/connection-websocket-brand.js</a>, <a href="connection_connection-websocket-brand.js.html#line335">line 335</a>
            </span>
        </p>
    ...
    <h4 class="name" id="_updateRingState">
        <a class="href-link" href="#_updateRingState">#</a>
        ...
        <span class="code-name">
                ...
                _updateRingState<span class="signature">(ringId, ringState)</span><span class="type-signature"></span>
    ...
    <div class="description">
        <p>Updates the state of a ring. If state is accepted, the agent will be assigned to the conversation.</p>
    </div>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>ringState</code></td>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="connection_connection-websocket-brand.js.html" class="button">View Source</a>
            <span>
                <a href="connection_connection-websocket-brand.js.html">connection/connection-websocket-brand.js</a>, <a href="connection_connection-websocket-brand.js.html#line346">line 346</a>
            </span>
        </p>
    ...
    <h4 class="name" id="getToken">
        <a class="href-link" href="#getToken">#</a>
        ...
        <span class="code-name">
                ...
                getToken<span class="signature">()</span><span class="type-signature"> &rarr; {Promise.&lt;string>}</span>
    ...
    <div class="description">
        <p>Returns the token from this connection. Throws an error if <a href="global.html#ConnectionState">ConnectionState</a> is not connected</p>
    </div>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="connection_connection-websocket-brand.js.html" class="button">View Source</a>
            <span>
                <a href="connection_connection-websocket-brand.js.html">connection/connection-websocket-brand.js</a>, <a href="connection_connection-websocket-brand.js.html#line54">line 54</a>
            </span>
        </p>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>token maintainer not started</p></div>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>Agent bearer token</p></div>
...
<span class="param-type">Promise.&lt;string></span>
    ...
    <h4 class="name" id="setAgentState">
        <a class="href-link" href="#setAgentState">#</a>
        ...
        <span class="code-name">
                ...
                setAgentState<span class="signature">(agentId, agentState)</span><span class="type-signature"></span>
    ...
    <div class="description">
        <p>Changes the availability of an agent</p>
    </div>
...
<span class="param-type">string</span>
  ...
  <td class="description last"><p>{accountId.userId}. Defaults to the agentId for the current connection</p></td>
</tr>
...
<tr class="deep-level-0">
      ...
      <td class="name"><code>agentState</code></td>
...
<span class="param-type">string</span>
  ...
  <td class="description last"><p>represents availability states of the agent: ONLINE, OFFLINE, AWAY, BACK_SOON</p></td>
</tr>
...
<dl class="details">
        ...
        <p class="tag-source">
            <a href="connection_connection-websocket-brand.js.html" class="button">View Source</a>
            <span>
                <a href="connection_connection-websocket-brand.js.html">connection/connection-websocket-brand.js</a>, <a href="connection_connection-websocket-brand.js.html#line313">line 313</a>
            </span>
        </p>
...
<div class="columns">
    ...
    <div class='param-desc column is-7'><p>void</p></div>
