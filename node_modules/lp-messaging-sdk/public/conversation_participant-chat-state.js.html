...
<head>
  ...
  <title> conversation/participant-chat-state.js</title>
...
<div class="top-nav">
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header class="page-title">
                    <p>Source</p>
                    <h1>conversation/participant-chat-state.js</h1>
                </header>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// https://lpgithub.dev.lprnd.net/Architecture/api-ums/blob/master/api-ums-ms/src/main/java/com/liveperson/api/ams/ms/types/ChatState.java

/**
 * @typedef {string} ParticipantChatState
 */

/**
 * @enum {ParticipantChatState}
 * @category Conversation
 */
const ParticipantChatState = {
    ACTIVE: 'ACTIVE',
    INACTIVE: 'INACTIVE',
    GONE: 'GONE',
    COMPOSING: 'COMPOSING',
...
// TODO how are the other states reached? Does UMS send an "INACTIVE" chat state?

module.exports = ParticipantChatState;
</code></pre>
        </article>
    </section>
