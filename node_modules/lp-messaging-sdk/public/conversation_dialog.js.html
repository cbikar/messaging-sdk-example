...
<head>
  ...
  <title> conversation/dialog.js</title>
...
class Dialog extends EventEmitter {
    ...
    processDialogStateNotification(dialogState, conversationContext) {
        ...
        participantsChanged.added.forEach(change => {
             ...
             */
            this.emit(DialogEvent.PARTICIPANT_ADDED, change.participant, change.context);
        });
    ...
    emit(type, ...args) {
        ...
        switch (type) {
            // whitelist events to be bubbled up to the conversation level
            ...
            case DialogEvent.MESSAGE_DELIVERY_EVENT:
                // if there is a listener for this event at conversation level, stop and do not emit it at dialog level
                return this.conversation.emit(type, ...args) || super.emit(type, ...args);
