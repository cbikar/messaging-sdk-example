...
<head>
  ...
  <title> conversation/dialog-change-type.js</title>
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header class="page-title">
                    <p>Source</p>
                    <h1>conversation/dialog-change-type.js</h1>
                </header>
 ...
 * @typedef {string} DialogChangeType
 */

/**
 * A enum of possible dialog change types
 * @enum {DialogChangeType}
 * @category Conversation
 */
const DialogChangeType = {
...
module.exports = DialogChangeType;
</code></pre>
        </article>
    </section>
