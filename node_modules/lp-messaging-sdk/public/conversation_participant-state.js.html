...
<head>
  ...
  <title> conversation/participant-state.js</title>
...
<div class="top-nav">
        ...
        <div class="core" id="main-content-wrapper">
            <div class="content">
                <header class="page-title">
                    <p>Source</p>
                    <h1>conversation/participant-state.js</h1>
                </header>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// https://lpgithub.dev.lprnd.net/Architecture/api-ums/blob/master/api-ums-cm/src/main/java/com/liveperson/api/ams/cm/types/fields/Participant.java#L57

/**
 * @typedef {string} ParticipantState
 */
...
module.exports = ParticipantState;</code></pre>
        </article>
    </section>
